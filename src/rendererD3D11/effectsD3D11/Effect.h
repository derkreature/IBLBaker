...
struct SVariable
{
    ...
    union
    {
        UINT                MemberDataOffsetPlus4;  // 4 added so that 0 == nullptr can represent "unused"
...
struct SAnonymousShader : public TUncastableVariable<ID3DX11EffectShaderVariable>, public ID3DX11EffectType
{
    ...
    SAnonymousShader(SShaderBlock *pBlock = nullptr);
