...
typedef uint32_t ImguiFontReference;

ImguiFontReference imguiCreateFont(const void* _data, float _fontSize=15.0f);
...
void imguiColorWheel(float* _rgb, bool _respectIndentation = false, float _size = 0.8f, bool _enabled = true);
void imguiColorWheel(const char* _str, float* _rgb, bool& _activated, float _size = 0.8f, bool _enabled = true);
